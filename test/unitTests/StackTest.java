...
public class StackTest
{
	...
	public void testPush_Top() throws EmptyStackException
	{
		...
		assertEquals( "Stack pushed wrong element to top of stack ", 1, actual );
		assertEquals( "Stack size is incorrect ", 1, stack.size() );

		stack.push( two );
		actual = stack.peek();
		assertEquals( "Stack pushed wrong element to top of stack ", 2, actual );
		assertEquals( "Stack size is incorrect ", 2, stack.size() );

		stack.push( three );
		actual = stack.peek();
		assertEquals( "Stack pushed wrong element to top of stack ", 3, actual );
		assertEquals( "Stack size is incorrect ", 3, stack.size() );

		stack.push( four );
		actual = stack.peek();
		assertEquals( "Stack pushed wrong element to top of stack ", 4, actual );
		assertEquals( "Stack size is incorrect ", 4, stack.size() );

		stack.push( five );
		actual = stack.peek();
		assertEquals( "Stack pushed wrong element to top of stack ", 5, actual );
		assertEquals( "Stack size is incorrect ", 5, stack.size() );
	}
